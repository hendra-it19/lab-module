...
@section('content')
    <div>
        ...
        <div>
            <form class="container-fluid" method="post" action="{{ route('properties.store') }}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="mb-3 row">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="file" class="form-control @error('foto') is-invalid @enderror"
                                    id="foto" accept="image/*" name="foto" value="{{ old('foto') }}">
                                @error('foto')
                            ...
                            <div class="col">
                                <img src="{{ url('user-1.jpg') }}" alt="preview" id="previewImage" width="70px"
                                    height="70px" class="img-responsive img img-thumbnail">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" class="form-control @error('nama_properti') is-invalid @enderror"
                            id="nama_properti" name="nama_properti" value="{{ old('nama_properti') }}">
                        @error('nama_properti')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
